...
const signup = () => {
    ...
    return (
        <div className=" min-h-screen">
            <div className=" w-[70vw] max-h-[95vh] rounded-lg overflow-y-scroll scrollbar  p-10 text-center shadow-lg mx-auto z-50 bg-gradient-to-r from-green-300 to-green-500 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                ...
                >
                    ...
                    <Button
                        className=" mt-3 w-60 bg-green-500 text-white hover:bg-white hover:text-green-500"
                        type="submit"
                    >
                        Sign Up
                    </Button>
